...
푸시 알림 기능을 사용하려면 반드시 VAPID 키를 생성하고 설정해야 합니다.
...
환경 변수를 추가한 후 서버를 재시작하면 푸시 알림이 활성화됩니다.

### VAPID 키가 없을 때

- 서버는 정상적으로 시작되지만 푸시 알림 기능만 비활성화됩니다
- 콘솔에 경고 메시지 표시: "⚠️ VAPID 키가 설정되지 않음. 푸시 알림 비활성화"
- 결제, 리뷰, 예약 등 다른 모든 기능은 정상 작동합니다
