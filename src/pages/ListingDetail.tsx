    ...
    <div className="container py-6">
      ...
      >
        ...
        <section className="space-y-4">
          ...
          {/* 액션 버튼 */}
          <div className="flex gap-3 items-center">
            <button className="px-3 py-2 text-sm text-gray-600 rounded-full border hover:bg-gray-50">
              ♡
            </button>
            <button className="px-3 py-2 text-sm text-gray-600 rounded-full border hover:bg-gray-50">
              ↗ 공유
            </button>
            <button className="px-6 ml-auto h-10 text-sm font-semibold text-white bg-black rounded-lg hover:opacity-90">
              채팅하기
            </button>
          </div>
        </section>
